...
class TianyiOrderModel extends CommonModel{
    //自动验证
    ...
    public function dataList($params){
        $this->sqlFrom = " cmf_tianyi_order ";              //数据库查询表
        ...
        if (!empty($params['keyword'])) {
            $this->sqlWhere .= " and  (order_sn like '%s' or order_name like '%s' or  user_name like '%s' or  mobile like '%s') ";
