...
<body>
    ...
    <div class="wrap js-check-wrap">
        <ul class="nav nav-tabs">
            <li class="active"><a href="<?php echo U('Actquestion/index');?>">问题列表</a></li>
            <li><a href="<?php echo U('Actquestion/update');?>">发布问题</a></li>
        </ul>
        <form class="well form-search" method="post" action="<?php echo U('Actquestion/index');?>"> 
            ...
            <a class="btn btn-danger" href="<?php echo U('Actquestion/index');?>">清空</a>
        </form>
        ...
        <table class="table table-hover table-bordered">
            ...
            <?php if(is_array($dataList)): foreach($dataList as $key=>$vo): ?><tr>
                    ...
                    <td>
                        <a href="<?php echo U('Actquestion/update',array('id'=>$vo['id']));?>">修改</a> | 
        ...
        <div class="table-actions">
            <button class="btn btn-primary btn-small js-ajax-submit"  type="submit" data-action="<?php echo U('Actquestion/updateStatus');?>" data-subcheck="true"  data-msg="你确定停用吗？">批量禁用</button>
        </div>
    ...
    <script>
        function updateStatus(id,status){
            layer.confirm('你确定更新状态吗？', function(){
                getRemoteData({ids:[id],status:status},"<?php echo U('Actquestion/updateStatus');?>",1);
            });
        }
    </script>
</body>
