...
<body>
    <?php $ctypeArray=array(1=>"单选",2=>"多选"); ?>
    <div class="wrap js-check-wrap">
        <ul class="nav nav-tabs">
            <li class="active"><a href="<?php echo U('Actsubject/index');?>">题目列表</a></li>
            <li><a href="<?php echo U('Actsubject/update');?>">发布题目</a></li>
        </ul>
        <form class="well form-search" method="post" action="<?php echo U('Actsubject/index');?>"> 
            ...
            <a class="btn btn-danger" href="<?php echo U('Actsubject/index');?>">清空</a>
        </form>
        ...
        <table class="table table-hover table-bordered">
            ...
            <?php if(is_array($dataList)): foreach($dataList as $key=>$vo): ?><tr>
                    ...
                    <td><?php echo ($ctypeArray[$vo['ctype']]); ?></td>
                    <td><?php echo ($vo["create_time"]); ?></td>
                    <td>
                        <a href="<?php echo U('Actsubject/update',array('id'=>$vo['id']));?>">修改</a> | 
        ...
        <div class="table-actions">
            <button class="btn btn-primary btn-small js-ajax-submit"  type="submit" data-action="<?php echo U('Actsubject/deleteInfo');?>" data-subcheck="true"  data-msg="你确定删除吗？">批量删除</button>
        </div>
    ...
    <script>
        function deleteInfo(id){
            layer.confirm('你确定删除吗？', function(){
                getRemoteData({ids:[id]},"<?php echo U('Actsubject/deleteInfo');?>",1);
            });
        }
    </script>
</body>
