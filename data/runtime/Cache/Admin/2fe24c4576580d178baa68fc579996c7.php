...
<body>
    ...
    <div class="wrap">
        <ul class="nav nav-tabs">
            <li><a href="<?php echo U('RuidaAppoint/index');?>">用户列表</a></li>
            <li  class="active"><a >用户详情</a></li>
        </ul>
        <form action="<?php echo U('RuidaAppoint/update');?>" method="post" class="form" id="advertUpdate" enctype="multipart/form-data">
            ...
            <div class="form-actions">
                ...
                <a class="btn btn-primary" href="<?php echo U('RuidaAppoint/index');?>">返回</a>
            </div>
        </form>
    </div>
