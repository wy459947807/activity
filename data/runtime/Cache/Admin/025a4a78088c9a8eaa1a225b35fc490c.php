...
<body>
    ...
    <div class="wrap">
        <ul class="nav nav-tabs">
            <li><a href="<?php echo U('SyhTeacher/index');?>">老师列表</a></li>
            <li  class="active"><a href="<?php echo U('SyhTeacher/update');?>">添加老师</a></li>
        </ul>
        <form action="<?php echo U('SyhTeacher/update');?>" method="post" class="form" id="dataUpdate" enctype="multipart/form-data">
...
<input type="button" class="btn btn-small" onclick="$('#icon-preview').attr('src', '/admin/themes/simplebootx/Public/assets/images/default-thumbnail.png');$('#icon').val('');return false;" value="取消图片">  
                        ...
                        <tr>
                            <th>老师简介</th>
                            <td>
                                <textarea name="intro" style="width: 50%; height: 100px;" placeholder="请填写老师简介"><?php echo ($intro); ?></textarea>
                            </td>
                        </tr>
            ...
            <div class="form-actions">
                ...
                <a class="btn" href="<?php echo U('SyhTeacher/index');?>">返回</a>
            </div>
        </form>
    </div>
