<?php
return array (
  'ADMIN_ACTANSWERER_INDEX' => '回答列表',
  'ADMIN_ACTQUESTION_DEFAULT' => '炒股测评',
  'ADMIN_ACTQUESTION_INDEX' => '问题列表',
  'ADMIN_ACTRESULT_INDEX' => '测评结果',
  'ADMIN_ACTSUBJECT_INDEX' => '题目列表',
  'ADMIN_ACTUSER_INDEX' => '微信用户',
  ...
  'ADMIN_RUIDAAPPOINT_DEFAULT' => '瑞达期货',
  'ADMIN_RUIDAAPPOINT_INDEX' => '申请列表',
  ...
  'ADMIN_SYHCOURSE_INDEX' => '课程列表',
  'ADMIN_SYHJOIN_DEFAULT' => '悦华专区',
  'ADMIN_SYHJOIN_INDEX' => '报名列表',
  'ADMIN_SYHTEACHER_INDEX' => '老师列表',
  'ADMIN_TIANYIORDER_DEFAULT' => '天翼阅读',
  'ADMIN_TIANYIORDER_INDEX' => '订单列表',
  ...
  'ADMIN_WUWEIARTICLE_INDEX' => '评论列表',
  'ADMIN_WUWEIJOIN_INDEX' => '报名列表',
  'ADMIN_WUWEITEACHER_DEFAULT' => '无为专区',
  'ADMIN_WUWEITEACHER_INDEX' => '老师管理',
